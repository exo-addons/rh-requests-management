define("rhEmployeesAdminControllers", ["SHARED/jquery", "SHARED/juzu-ajax", "SHARED/userInvitation", "moment"], function ($, jz, invite, moment) {
    var rhAdminCtrl = function ($scope, $q, $timeout, $http, $filter, PagerService, Upload) {
        var rhEmployeesAdminContainer = $('#rhEmployeesAdmin');
...
//        };
        ...
        $scope.loadBundles = function () {
            $http({
                method: 'GET',
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getBundle') + "&locale=" + eXo.env.portal.language
        ...
        $scope.loadEmployees = function (emFilter) {
            $http({
                method: 'GET',
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getAllUsersRhData')+ "&emfilter=" + emFilter
            }).then(function successCallback(data) {
        ...
        $scope.loadVacationRequestsbyUserId = function (userId,userVrFilter) {
            $http({
                method: 'GET',
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getVacationRequestsbyUserId') + "&userId=" + userId+ "&vrFilter=" + userVrFilter
            }).then(function successCallback(data) {
        ...
        $scope.getUser = function (newUserId) {
            ...
            if (newUserId) {
                ...
                $http({
                    method: 'GET',
                    url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getUser') + "&userId=" + newUserId
                }).then(function successCallback(data) {
        ...
        $scope.loadVacationRequests = function (vrFilter,offset,limit) {
            ...
            $http({
                method: 'GET',
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getVacationRequests')+url+ "&offset="+offset+ "&limit="+limit
            }).then(function successCallback(data) {
...
//                }, 1000);
        ...
        $scope.saveUserHRData = function (employee) {
            ...
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.saveUserRHData')
            }).then(function successCallback(data) {
        ...
        $scope.deleteUserHRData = function (employee) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.deleteUserRHData')
            }).then(function successCallback(data) {
                $scope.loadEmployees($scope.emFilter);
        ...
        $scope.validateRequest = function (vacationRequest, user) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.validateRequest')
            }).then(function successCallback(data) {
                if (user == null) {
...
//                $scope.setResultMessage(data, "success");
        ...
        $scope.cancelRequest = function (vacationRequest, user) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.cancelRequest')
            }).then(function successCallback(data) {
                if (user == null) {
                    $scope.loadVacationRequests($scope.vrFilter,$scope.currentPage*$scope.itemsPerPage, $scope.itemsPerPage);
                } else {
...
//                $scope.setResultMessage(data, "success");
        ...
        $scope.uploadFiles = function (file, errFiles) {
            ...
            if (file) {
                file.upload = Upload.upload({
                    url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.uploadFile'),
                    data: {
        ...
        $scope.loadAttachments = function (userDetails) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getEmployeeAttachements')
            }).then(function successCallback(data) {
...
//                }, 1000);
        ...
        $scope.deleteAttachement = function (fileName) {
            $http({
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.deleteFile') + "&userId=" + $scope.userDetails.userId + "&fileName=" + fileName
            }).then(function successCallback(data) {
                $scope.attachements = $scope.loadAttachments($scope.userDetails);
//                $timeout(function() {
//                    $scope.setResultMessage(data, "success")
...
/*here*/
        ...
        $scope.loadSubstitues = function (vacationRequest) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getSubstitutesByRequestID')
            }).then(function successCallback(data) {
...
//                }, 1000);
        ...
        $scope.loadManagers = function (vacationRequest) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getValidatorsByRequestID')
            }).then(function successCallback(data) {
...
//                }, 1000);
        ...
        $scope.loadComments = function (vacationRequest) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getComments')
            }).then(function successCallback(data) {
...
//            $scope.setResultMessage($scope.i18n.savingVacationRequest, "info");
            if ($scope.newComment.commentText) {
                ...
                $http({
                    ...
                    url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.saveComment')
                }).then(function successCallback(data) {
        ...
        $scope.loadRequestAttachments = function (vacationRequest) {
            $http({
                ...
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getRequestAttachements')
            }).then(function successCallback(data) {
                $scope.attachements = data.data;
//                $timeout(function() {
//                    $scope.setResultMessage(data, "success")
//                }, 1000);
        ...
        $scope.loadContext = function () {
            $http({
                method: 'GET',
                url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getContext')
            }).then(function successCallback(data) {
...
//                $scope.setResultMessage(data, "success");
        ...
        $scope.showRequestfromUrl = function() {
            ...
            if (typeof requestId !== 'undefined' && requestId !==null) {
                $http({
                    method : 'GET',
                    url : rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.getVacationRequest')+ "&id=" +requestId
                }).then(function successCallback(data) {
                    if(data.data==""){
...
//            return Date.parse(dateSplit[1]+'-'+dateSplit[0]+'-'+dateSplit[2]);
        ...
        $scope.updateVacationRequest = function (vacation) {
            ...
            if(vacation.daysNumber < 0){
                ...
                $http({
                    ...
                    url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.updateVacationRequest')
                }).then(function successCallback(data) {
                ...
                $scope.saveVacationRequest = function (vacation) {
                    ...
                    if(vacation.daysNumber < 0){
                        ...
                        $http({
                            ...
                            url: rhEmployeesAdminContainer.jzURL('RhEmployeesAdministrationController.saveVacationRequest')
                        }).then(function successCallback(data) {
    ...
    $scope.setVr = function(vRequest) {
        ...
        $('#rhEmployeesAdmin').css('visibility', 'visible');
        $("#rhLoadingBar").remove();
    };
    return rhAdminCtrl;
