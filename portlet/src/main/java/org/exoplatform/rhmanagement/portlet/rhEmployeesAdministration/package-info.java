@Portlet
@Application(name = "RhEmployeesAdministrationController")
@Bindings({
...
@Scripts({
    ...
    @Script(id = "rh-employees-admin", value = "js/rh-employees-admin.js", depends = { "controllers","jQueryUI" }),
...
@Stylesheets({
        ...
        @Stylesheet(id = "rh-employees-admin-skin", value = "style/rh-employees-admin.css") })

@Assets("*")
package org.exoplatform.rhmanagement.portlet.rhEmployeesAdministration;
