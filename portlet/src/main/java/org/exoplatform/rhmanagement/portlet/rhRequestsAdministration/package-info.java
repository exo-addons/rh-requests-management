@Portlet
@Application(name = "RhRequestsAdministrationController")
@Bindings({
...
@Scripts({
    ...
    @Script(id = "rhRequestAdmin", value = "js/rh-request-admin.js", depends = { "controllers","jQueryUI" }),
...
@Stylesheets({
        ...
        @Stylesheet(id = "rh-request-admin", value = "style/rh-request-admin.css") })
