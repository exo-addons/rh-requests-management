...
require( ["SHARED/jquery", "rhEmployeesAdminControllers"], function ( $,  rhEmployeesAdminControllers)
{
	$( document ).ready(function() {
	  var rhEmployeesAdminAppRoot = $('#rhEmployeesAdmin');
      var rhEmployeesAdminApp = angular.module('rhEmployeesAdminApp', ['ngFileUpload'])
      .factory('PagerService', PagerService);
        rhEmployeesAdminApp.filter('startFrom', function() {
      ...
      try {
          rhEmployeesAdminApp.controller('rhAdminCtrl', rhEmployeesAdminControllers);
		  angular.bootstrap(rhEmployeesAdminAppRoot, ['rhEmployeesAdminApp']);
      } catch(e) {
    	  console.log(e);
      }
